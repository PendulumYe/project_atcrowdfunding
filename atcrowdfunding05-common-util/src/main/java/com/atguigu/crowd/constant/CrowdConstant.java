...
public class CrowdConstant {
    ...
    public static final String MESSAGE_LOGIN_ACCT_ALREADY_IN_USE = "该账号已被注册！";

    public static final String MESSAGE_ACCESS_FORBIDEN = "请先登录再进行访问！";

    public static final String MESSAGE_STRING_INVALIDATE = "字符串异常，请不要传入空字符串！";

    public static final String MESSAGE_SYSTEM_ERROR_LOGIN_NOT_UNIQUE = "系统错误：登录账号不唯一！请联系开发人员！";
