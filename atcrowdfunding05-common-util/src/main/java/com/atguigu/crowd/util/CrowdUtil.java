...
public class CrowdUtil {
    ...
    public static ResultEntity<String> sendCodeByShortMessage(
            String host, String path, String method, String phoneNum, String appCode, String sign, String skin) {
    ...
    public static ResultEntity<String> uploadFileToOss(
        ...
        try {
            ...
            if(responseMessage == null) {
                ...
                // 当前方法返回成功
                System.out.println("图片上传路径：" + ossFileAccessPath);
...
//        InputStream inputStream = new FileInputStream("E:\\atcrowdfunding\\atcrowdfunding05-common-util\\333.jpg");
//        ResultEntity<String> resultEntity = uploadFileToOss("http://oss-cn-shenzhen.aliyuncs.com",
//                "LTAI4FtyK7WcqxaiE9ttukNi",
//                "43OFOgMghjsitNsNlTGqcpPGgyzqgU",
//                inputStream,
//                "atguigu190830",
//                "http://atguigu190830.oss-cn-shenzhen.aliyuncs.com",
//                "333.jpg");
